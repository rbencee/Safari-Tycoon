...
public class AnimalFactory {
    public static Animal createCapybara(Position position){
        return new AnimalImpl(30f, 0, 10, 100, 100, 3, createTexture("textures/animals/capybara.png"), position, AnimalSpecies.CAPYBARA, new HerbivoreBehaviour());
    }
    ...
    public static Animal createDinosaur(Position position){
        return new AnimalImpl(30f, 0, 10, 100, 100, 4, createTexture("textures/animals/dino.png"), position, AnimalSpecies.DINOSAUR, new PredatorBehaviour());
    }
